...
var slide_ability_values : Dictionary = {
	...
	SlideAbilityID.NO_RELOAD : {"purchased" : false, "name": "Reload Slide", "shop_cost" : 0, 
	...
	"multiplier" : 0.25, "speed" : 12, "description" : "A Slide that considerably slows time down.", 'icon' : preload("res://icon.svg") },
	...
	"multiplier" : 0.1, "speed" : 15, "description" : "A Slide that slows down time to a halt.", 'icon' : preload("res://icon.svg") },
}
...
var dash_ability_values : Dictionary = {
	...
	"cost" : -1.5, "distance" : 10, "cooldown" : 2, "amount" : 5, "description" : "A Quintuple Dash.", 'icon' : preload("res://icon.svg") },
